...
var AnthropicStreamingParallelTestCmd = &cobra.Command{
	Use:   "anthropic-streaming-parallel",
	Short: "Test Anthropic streaming with multiple parallel tool calls",
	Run:   runAnthropicStreamingParallelTest,
}
...
func runAnthropicStreamingParallelTest(cmd *cobra.Command, args []string) {

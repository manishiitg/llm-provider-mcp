...
var AzureStreamingCancellationTestCmd = &cobra.Command{
	Use:   "azure-streaming-cancellation",
	Short: "Test Azure AI streaming cancellation",
	Run:   runAzureStreamingCancellationTest,
}

func init() {
	AzureStreamingCancellationTestCmd.Flags().String("model", "gpt-4o", "Azure AI model to test")
	AzureStreamingCancellationTestCmd.Flags().String("endpoint", "", "Azure AI endpoint (or set AZURE_AI_ENDPOINT env var)")
	AzureStreamingCancellationTestCmd.Flags().String("api-key", "", "Azure AI API key (or set AZURE_AI_API_KEY env var)")
}

func runAzureStreamingCancellationTest(cmd *cobra.Command, args []string) {
	...
	// Run streaming cancellation test
